import{B as t,x as e}from"./lit-element-d0893540.js";const o={1:{k:0,d:0},r:{k:1,d:0},r2:{k:2,d:0},f:{k:0,d:1},rf:{k:1,d:1},r2f:{k:2,d:1}};function i(t,e){const i=o[t],n=o[e];let r=i.k+(0===i.d?n.k:-n.k);r=(r%3+3)%3;const a=(i.d+n.d)%2;for(let t in o){const e=o[t];if(e.k===r&&e.d===a)return t}return null}class n extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.setupInteractive()}resetTriangle(){const t=this.shadowRoot.getElementById("triangle-group");t&&(t.getAnimations().forEach((t=>t.cancel())),t.setAttribute("transform","rotate(0) scale(1)"));this.shadowRoot.querySelectorAll(".vertex-label").forEach((t=>t.removeAttribute("transform")))}animateRotation(t,e=500){const o=this.shadowRoot.getElementById("triangle-group");if(!o)return;let i=null;const n=r=>{i||(i=r);const a=r-i,s=Math.min(a/e,1),l=0+s*(t-0);if(o.setAttribute("transform",`rotate(${l})`),s<1)requestAnimationFrame(n);else{this.shadowRoot.querySelectorAll(".vertex-label").forEach((e=>{const o=e.getAttribute("x"),i=e.getAttribute("y");e.setAttribute("transform",`rotate(-${t}, ${o}, ${i})`)}))}};requestAnimationFrame(n)}animateFlip(t=500){const e=this.shadowRoot.getElementById("triangle-group");if(!e)return;let o=null;const i=n=>{o||(o=n);const r=n-o,a=Math.min(r/t,1),s=1+-2*a;if(e.setAttribute("transform",`rotate(0) scale(${s}, 1)`),a<1)requestAnimationFrame(i);else{this.shadowRoot.querySelectorAll(".vertex-label").forEach((t=>{const e=t.getAttribute("x"),o=t.getAttribute("y");t.setAttribute("transform",`translate(${e}, ${o}) scale(-1,1) translate(${-e}, ${-o})`)}))}};requestAnimationFrame(i)}animateFlipThenRotation(t,e=500,o=500){const i=this.shadowRoot.getElementById("triangle-group");if(!i)return;let n=null;const r=t=>{n||(n=t);const o=t-n,s=Math.min(o/e,1),l=1+-2*s;if(i.setAttribute("transform",`rotate(0) scale(${l}, 1)`),s<1)requestAnimationFrame(r);else{this.shadowRoot.querySelectorAll(".vertex-label").forEach((t=>{const e=t.getAttribute("x"),o=t.getAttribute("y");t.setAttribute("transform",`translate(${e}, ${o}) scale(-1,1) translate(${-e}, ${-o})`)})),a()}},a=()=>{let e=null;const n=r=>{e||(e=r);const a=r-e,s=Math.min(a/o,1),l=s*t;if(i.setAttribute("transform",`rotate(${l}) scale(-1,1)`),s<1)requestAnimationFrame(n);else{this.shadowRoot.querySelectorAll(".vertex-label").forEach((e=>{const o=e.getAttribute("x"),i=e.getAttribute("y");e.setAttribute("transform",`translate(${o}, ${i}) scale(-1,1) rotate(-${t}) translate(${-o}, ${-i})`)}))}};requestAnimationFrame(n)};requestAnimationFrame(r)}raiseTriangle(){const t=this.shadowRoot.getElementById("triangle-group");if(t){const e=t.getAttribute("transform")||"";t.animate([{transform:e},{transform:"scale(1.2)"}],{duration:150,fill:"forwards",easing:"ease-out"}),t.setAttribute("transform","scale(1.2)")}}lowerTriangle(){const t=this.shadowRoot.getElementById("triangle-group");if(t){const e=t.getAttribute("transform")||"";t.animate([{transform:e},{transform:"scale(1)"}],{duration:150,fill:"forwards",easing:"ease-out"}),t.setAttribute("transform","scale(1)")}}setupInteractive(){this.shadowRoot.getElementById("check-closure").addEventListener("click",(()=>{const t=this.shadowRoot.getElementById("closure-a").value,e=this.shadowRoot.getElementById("closure-b").value,o=i(t,e);this.shadowRoot.getElementById("closure-result").textContent=`Result: ${t} · ${e} = ${o}. Closure holds because the result is in D₃.`})),this.shadowRoot.getElementById("check-identity-prop").addEventListener("click",(()=>{const t=this.shadowRoot.getElementById("identity-element").value,e=i("1",t);this.shadowRoot.getElementById("identity-result-prop").textContent=`Result: 1 · ${t} = ${e}. The identity element is 1.`})),this.shadowRoot.getElementById("check-associativity-prop").addEventListener("click",(()=>{const t=this.shadowRoot.getElementById("assoc-a").value,e=this.shadowRoot.getElementById("assoc-b").value,o=this.shadowRoot.getElementById("assoc-c").value,n=i(i(t,e),o),r=i(t,i(e,o));let a=`Result: ( ${t} · ${e} ) · ${o} = ${n} and ${t} · ( ${e} · ${o} ) = ${r}. `;a+=n===r?"Associativity holds.":"Associativity fails!",this.shadowRoot.getElementById("associativity-result-prop").textContent=a})),this.shadowRoot.getElementById("check-inverse-prop").addEventListener("click",(()=>{const t=this.shadowRoot.getElementById("inverse-element").value,e=function(t){for(let e in o)if("1"===i(t,e))return e;return null}(t),n=i(t,e);this.shadowRoot.getElementById("inverse-result-prop").textContent=`Result: ${t} · (${e}) = ${n}. Inverse holds.`}))}render(){const o=e`
      <style>
        :host {
          display: block;
    ...
    `;t(o,this.shadowRoot)}}customElements.define("triangle-group-demo",n);
